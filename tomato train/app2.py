...
model = load_model(r'D:/CROP DISEASE DETECTION/NEW TRAINED/tomato train/model(94).h5')  # Ensure model.h5 is in the same directory
print('Tomato Model loaded. Check http://127.0.0.1:5002/')

# Define label mapping for Tomato (4 classes: Early Blight, Late Blight, Leaf Mold, Healthy)
labels = {0: 'Early Blight', 1: 'Late Blight', 2: 'Leaf Mold', 3: 'Healthy'}

# Set the path to the disease_info.json file
json_path = r"D:/CROP DISEASE DETECTION/NEW TRAINED/tomato train/disease_info.json"
...
if __name__ == '__main__':
    app.run(debug=True, port=5002)  # Run on port 5002 for Tomato model
